...
#ifndef TDDEXAMPLE_SWIFT_H
#define TDDEXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TDDExample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10TDDExample11AppDelegate")
...
SWIFT_CLASS("_TtC10TDDExample13SceneDelegate")
...
SWIFT_CLASS("_TtC10TDDExample20SignupViewController")
...
- (void)viewDidLoad;
- (IBAction)signupBtnTapped:(id _Nonnull)sender;
